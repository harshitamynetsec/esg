...
export default function SubscriptionsPage() {
  return (
    <ResourcePage
      title="Subscriptions"
      description="Manage billing plans, seats, renewal windows, and subscription status."
      resource="subscriptions"
      defaults={{ plan: 'starter', status: 'trialing', seats: 5, amount: 0, currentPeriodStart: '2026-07-01', currentPeriodEnd: '2026-08-01' }}
      columns={[
        { key: 'plan', label: 'Plan' },
